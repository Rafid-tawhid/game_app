...
class MultiplicationPage extends StatefulWidget {
  static const String routeName='mup';
...
class _MultiplicationPageState extends State<MultiplicationPage> {
  ...
  @override
  void initState() {
    HelperClass.fetchHigestScoreFromSharedPref("mup").then((value) {
      setState(() {
        _higestScore=value;
      });
    });
  ...
  Future<void> dispose() async {
    if(_score>=_higestScore){
      HelperClass.saveHigestScoreToSharedPref(_score, "mup");
    }
    super.dispose();
  }
